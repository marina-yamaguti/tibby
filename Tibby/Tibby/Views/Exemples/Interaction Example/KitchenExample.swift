        ...
        NavigationStack {
            VStack {
                ...
                if (service.getAllTibbies().isEmpty) {
                    service.createTibby(id: UUID(), ownerId: service.getUser()?.id, name: "Shark", rarity: "", details: "", personality: "", species: "shark", level: 0, xp: 0, happiness: 0, hunger: 0, sleep: 0, friendship: 0, lastUpdated: Date(), isUnlocked: false, collection: "seaSeries")
                }
